...
{
    UIPasteboard *pasteboard = [UIPasteboard pasteboardWithName:DEVICE_IDENTIFIER create:NO];
    if (!pasteboard) {
        ...
        pasteboard = [UIPasteboard pasteboardWithName:DEVICE_IDENTIFIER create:YES];
